// components/AddPlayListModal.tsx
...
import { createPlaylistStart, reset } from "../../features/playlist/PlayListSlice";
...
const AddPlayListModal: React.FC<AddPlayListModalProps> = ({ isOpen, onClose }) => {
  ...
  const { isLoading ,isPlaylostaddSuccefully } = useSelector(
  ...
  const handleAddPlayList = async () => {
    if(!imageURL){
     toast.error("image url dosn't found")
      ...
      toast.error("you have to logg in first")
    }else{
      const userId = user?._id
      console.log("inputs", imageURL, description, name, userId)
      dispatch(createPlaylistStart({userId , name, imageURL, description}))
    }
